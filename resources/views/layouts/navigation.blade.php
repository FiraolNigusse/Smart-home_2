                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-dropdown align="left" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('security.tokens.index')" :active="request()->routeIs('security.tokens.*')">
                                {{ __('API Tokens') }}
                            </x-dropdown-link>
                            @endif
                            <x-dropdown-link :href="route('security.biometrics.index')" :active="request()->routeIs('security.biometrics.*')">
                                {{ __('Biometrics') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
