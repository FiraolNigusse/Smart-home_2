                    ...
                    <form method="POST" action="{{ route('rules.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="condition_type" id="condition_type" required class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                                ...
                                <option value="location" {{ old('condition_type') === 'location' ? 'selected' : '' }}>Location</option>
                                <option value="device_type" {{ old('condition_type') === 'device_type' ? 'selected' : '' }}>Device Type</option>
                                <option value="attribute" {{ old('condition_type') === 'attribute' ? 'selected' : '' }}>User Attribute</option>
                            </select>
